        ...
        body: ListView(
          children: <Widget>[
            Container(
                ...
                child: Text("한동샘의 비전", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold))
            ),
            Container(
              padding: EdgeInsets.only(left: 15, right: 15, bottom: 10),
              child: Image.network("https://firebasestorage.googleapis.com/v0/b/final-exam-de688.appspot.com/o/vision.jpg?alt=media&token=73b49221-4564-45d5-b001-d96e65d8eae1", fit: BoxFit.contain, height: 150),
            ),
            Container(
